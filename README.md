...
- CV (Web+Pdf) - [Portfolio](https://github.com/flourdau/lourdaux.florian.net)
...
Windows, VirtualBox, Debian, Xfce, nftables, fail2ban, htop, emacs, git, curl, fonts-recommended, vs-codium, nodejs, apache2, maraidb, php, composer, adminer, node-red, symfony, docker.
___
